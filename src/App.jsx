...
function App() {
  ...
  // const reflect = [
  //   "ユーザからの入力を受け取り、それを指定された文字数の範囲内に要約してください。要約された文章の文字数の上限と下限を指定できるようにし、文字数が範囲内に収まっていない場合には、文字を追加または削除する処理を繰り返します。" +
  //   "1. ユーザから次の情報を入力してもらいます。" +
  //   "- 入力する文章: (ここに文章入れる)" +
  //   "- 文字数の下限: 40" +
  //   "- 文字数の上限: 80" +
  ...
  //   "5. 最終的な要約された文章を表示し、ユーザが満足するまで、文章を調整します。"
  // ]
  //最初のメッセージ
