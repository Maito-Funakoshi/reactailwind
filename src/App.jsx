...
function App() {
  ...
  "参加者はユーザ、高橋、西村、山田です。" +
  "高橋、西村、山田は治療スタッフで、ユーザがいないと想定してスタッフ同士で議論するリフレクティングを行います。" +
  ...
  "彼の疲れと悔しさは、とても共感できるね。準備不足を感じることは誰にでもあることだけど、それを次にどう活かすかが重要だと思う。" +
  "そうですね。私も同じような経験があります。イベントやプレゼンの後にもっとできたはずだと思うことは多いです。でも、彼が次に向けて前向きに準備しようとしているのは、とても良い姿勢だと思います。" +
  "僕も同感です。次回のために具体的な準備を考えるというのは、大事なステップだと思います。私たちも、彼がもっと良いイベントを開催できるようにサポートしたいですね。"
]
  //最初のメッセージ
