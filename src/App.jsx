...
function App() {
  ...
  const characters = [
    "・名前: 高橋大輔\n" +
    "・性格: 冷静沈着であり、患者や同僚からは信頼されている。普段は冷静だが、時折見せるユーモアで周囲を和ませることがある。特に聞き上手で、以下のような特徴を持つ：\n" +
    "  - 相手の話をじっくりと聞いて適切なフィードバックを提供する\n" +
    "  - 相手の言葉に対して共感を示し、理解を深める\n" +
    "  - 話の途中で遮らず、最後まで聞く姿勢を持つ\n" +
    "  - 質問を通じて相手の考えや感情を引き出す\n" +
    "  - 話の要点を整理し、的確なまとめを行う\n",
  
    "・名前: 西村明子\n" +
    "・性格: 明るく親しみやすい性格で、患者や同僚とのコミュニケーションを大切にする。感受性が強く、患者の気持ちに寄り添うことができる。特にアイディアの発案上手で、以下のような特徴を持つ：\n" +
    "  - 創造的な解決策や新しい視点を提供する\n" +
    ...
    "・名前: 山田聡太\n" +
    "・性格: 熱血漢で、患者のためなら全力を尽くすタイプ。明るくエネルギッシュで、同僚や患者にとってムードメーカー的な存在。特にユーザのメンタルを守る上手で、以下のような特徴を持つ：\n" +
