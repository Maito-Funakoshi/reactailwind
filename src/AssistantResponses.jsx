        ...
        for (let i = 0; i < clients.length; i++) {
          try {
            ...
            if (i == 0) {
                ...
                //返信を作成
                const response0 = await clients[0].getChatCompletions(deploymentId, messages0, { maxTokens: 256 });
                //ログに追加
            ...
            if (i == 1) {
                ...
                //返信を作成
                const response1 = await clients[1].getChatCompletions(deploymentId, messages1, { maxTokens: 256 });
                //ログに追加
            ...
            if (i == 2) {
                ...
                //返信を作成
                const response2 = await clients[2].getChatCompletions(deploymentId, messages1, { maxTokens: 256 });
                //ログに追加
