        ...
        for (let i = 0; i < names.length; i++) {
          try {
            ...
            if (i == 0) {
                ...
                //返信を作成
                const response0 = await client.getChatCompletions(deploymentId, messages0, { maxTokens: 256 });
                //ログに追加
            ...
            if (i == 1) {
                ...
                //返信を作成
                const response1 = await client.getChatCompletions(deploymentId, messages1, { maxTokens: 256 });
                //ログに追加
