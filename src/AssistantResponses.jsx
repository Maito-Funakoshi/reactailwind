                ...
                for(let i = 0; i < names.length * reflectChatCount; i++){
                    ...
                    try {
                        ...
                        let response = await openai.chat.completions.create({
                          ...
                          logit_bias: {4802:-100, 30:-100, 177776:-100, 157351:-100, 44900:-100, 42993:-100, 103554:-100, 165732:-100, 177401:1, 25885:2, 16407:2, 15121:2, 14429:2},
                          temperature: 1.2
                        })
                        ...
                        response = await openai.chat.completions.create({
                          model: "gpt-4o",
                          messages: commonMessages,
                          logit_bias: {4802:-100, 30:-100, 177776:-100, 157351:-100, 44900:-100, 42993:-100, 103554:-100, 165732:-100, 177401:2, 25885:2, 16407:2, 15121:2, 14429:2},
                          temperature: 1.2
                        })
